...
PL_screw_holes = PLpatternXY(PLcircle(2),1,2,35,35);
CPL_top =  [PLsquare(12,servo_d(2));NaN NaN;PLtrans(PL_screw_holes,[0 0])];
SG_screw_plate = SGofCPLz(CPL_top,4);

PL_brace_top = PLsquare(10,servo_d(2));
PL_brace_bottom = PLtrans(PLsquare(5,servo_d(2)),[-2.5 0]);
