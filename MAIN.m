...
% CPL2 = PLtrans(PLkidney(4,14,pi/6.5),[-9 0]);
% CPL3 = PLtrans(PLkidney(2,12,pi/12),[-7 0]);
% [SGm,SGc,ranges] = SGmanipulator({{CPL;CPL2},{CPL2;CPL3},{PLcircle(5)}},[6;4;3],{[90 75 75 1;0 90 90 0;90 120 120 0],[0 20 20 0;90 90 90 0;0 50 50 0],[90 20 20 0;0 90 90 0;0 50 50 2]},{[27;30;55],[10;10;10],[10;10;20]},'angles',[-0.9 0 1;0.5 0 0;-0.9 0 0.5 ],'num_arms',3,'bottom_up','first_single');
%% FOUR ARM TEST
% CPL = PLtrans(PLkidney(7,17,pi/6.5),[-12 0]);
% CPL2 = PLtrans(PLkidney(4,14,pi/6.5),[-9 0]);
% CPL3 = PLtrans(PLkidney(2,12,pi/12),[-7 0]);
...
% CPL = PLtrans(PLkidney(7,17,pi/6.5),[-12 0]);
% CPL2 = PLtrans(PLkidney(4,14,pi/6.5),[-9 0]);
% [SGm,SGc,ranges] = SGmanipulator({{CPL;CPL2},{CPL;CPL2},{PLcircle(4.5)}},[6;6;3.5],{[90 60 60 1;0 70 70 0;90 120 120 0],[90 60 60 1;0 70 70 0;90 120 120 0],[0 120 45 -1;0 150 150 2]},{[27 4 1.2 1 0.5;30 4 1.0 1 0.5;55 2 0.8 2 0.5],[27 4 1.2 1 0.5;30 4 1.0 1 0.5;55 2 0.8 2 0.5],[25 2 1 1 0.5;40 2 1 0.25 0.5]},'optic_mid','angles',[-0.5 0 0;-0.5 0 0;0 0 0],'num_arms',4,'bottom_up','first_single','hole_radius',0.75,'optic_radius',2.2);
% [SGm,SGc,ranges] = SGmanipulator({{CPL;CPL2},{CPL;CPL2},{PLcircle(4)}},[6;6;1.5],{[90 60 60 1;0 70 70 0;90 120 120 0],[90 60 60 1;0 70 70 0;90 120 120 0],[0 120 45 -1;0 150 150 2]},{[27 4 1.2 1 0.5;30 4 1.0 1 0.5;55 2 0.8 2 0.5],[27 4 1.2 1 0.5;30 4 1.0 1 0.5;55 2 0.8 2 0.5],[25 2 1 1 0.5;40 2 1 0.25 0.5]},'optic_mid','angles',[-0.3 0 0;-0.3 0 0;0 0 0],'num_arms',4,'bottom_up','first_single','hole_radius',0.75,'optic_radius',2.2);


%% ENDOSKOPTESTS
% CPL_endoskop = [PLcircle(8.5);NaN NaN;PLtrans(PLcircle(1.4),[-6 0]);NaN NaN;PLtrans(PLcircle(1.4),[6 0])];
% [SGm,SGc,ranges] = SGmanipulator({CPL_endoskop},[7.5],{[45 270 270 2]},{[120 2 0.8 0.25 0.5]},'angles',[0],'bottom_up','single','tip');

%  CPL_endoskop = [PLcircle(3.5);NaN NaN;PLtrans(PLcircle(0.75),[-2 0])];
% [SGm,SGc,ranges] = SGmanipulator({CPL_endoskop},[1.5],{[45 360 360 2]},{[80 2 0.5 0.25 0.5]},'angles',[-0],'bottom_up','single','tip','hole_radius',0.4);

% [SGm,SGc,ranges] = SGmanipulator({PLcircle(3.5)},[3],{[45 360 360 2]},{[60 2 0.5 0.25 0.5]},'angles',[-0],'bottom_up','single','tip','hole_radius',0.4);
...
% [SGm,SGc,ranges] = SGmanipulator({flip(CPL_G)},[7],{[45 270 270 2]},{[40 2 0.8 0.25 0.5]},'angles',[0],'bottom_up','tip');
...
CPL_G_in = CPLselectinout(CPL_G,1);
CPL_G_out = CPLselectinout(CPL_G,0);
[SGm,SGc,ranges] = SGmanipulator({flip(CPL_G)},[7],{[45 270 270 2]},{[40 2 0.8 0.25 0.5]},'angles',[0],'bottom_up');
...
% SGplot(SGmanipulatorBoxSimple([60 60 60]));
