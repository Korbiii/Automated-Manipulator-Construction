...
SGmanipulator({PLcircle(5)},...     
                          ...
                          0,...     
                         15,...     
               'length',20);        ...Parameter to set shaft length. Value is in mm. Cant be shorter than crimp connector which is around 16mm
view(90,0);
...
SGmanipulator({PLcircle(5)},...     
                   ...
                   'length',50);        ...Parameter to set shaft length
...
SGmanipulator({{CPL},{CPL},{CPL},{CPL}},...     
                              ...
                              {0,0,0,0},...     
                           {15,12,15,12},...     
                   'length',20);        ...Parameter to set shaft length
...
SGmanipulator({{CPL;CPL2;CPL3},{CPL;CPL2;CPL3}},...
                                          [2;2],...
                                                ...
             {[90 10 50 0;0 60 60 0;90 90 90 0],...
             [90 10 50 0;0 60 60 0;90 90 90 0]},...
                                                ...
                                       {[7;7;7],...
                                       [7;7;7]},...
                                                ...
                                       'single',...
                                    'optic_mid',...     Adds a channel between the manipulator arms.
                               'optic_radius',4,...     Defines the radius of the optic channel between the arms.
                                      'flex',30,...
                                    'length',50,...
            'angles',[-0.8,-0.3,1;-0.8,-0.3,1]);        ...Flag to pre deflect the section in percent respective to their maximum deflection.
    
view(3); delete(findobj('type', 'patch','FaceAlpha',0.3));

%% Example for laprascopic manipulator
%
...
SGmanipulator({{CPL;CPL2},{CPL;CPL2},{CPL_camera}},...
                                           [5;5;4],...
                                                   ...    
   ...
   {[27 4 1.2 3 0.5;30 4 1.0 0 0.5;55 2 0.8 4 0.5],...
    [27 4 1.2 3 0.5;30 4 1.0 0 0.5;55 2 0.6 4 0.5],...
                    [30 2 1 2 0.5;40 2 0.6 1 0.5]},...
                                                   ...
           'angles',[-0.6 0 0.2;-0.6 0 0.2;0 -0 0],...
                                    'first_single',...      Flag to generate the first section as a section with only one bowdencable channel.
                                'hole_radius',0.75,...      This flag is used to alter the radius for the bowdencable channels. Default is 0.7
                                       'length',180);
