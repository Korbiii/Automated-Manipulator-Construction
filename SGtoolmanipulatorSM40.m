...
PL_rotator_servo_mount = [PLtrans(PLsquare(48,28.5),[-8 0]);NaN NaN;PLpatternXY(PLcircle(1.5),2,2,12,16)];
...
SG_rotator_servo_mount_bracket = SGofCPLz(PLsquare(40,48),5);
